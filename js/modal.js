...
document.getElementById('rates').onclick = function(){
  ...
  html:
    '<h4 style="margin-bottom: -5px; text-align: left;">What`s with these hour rates?<h4>' +
    ...
    '<hr/>' +
    '<h5 style="margin-bottom: -5px;">United States of America<h5>' +
    ...
    // '<hr/>' 
    +
    '<h5 style="margin-bottom: -5px;">Brazil<h5>' +
    ...
    '<hr/>' + 
    '<h5 style="margin-bottom: -5px;">Canada<h5>' +
    '<p style="margin-bottom: 5px; font-size: 14px">' + '<strong>USD: </strong>' + 'between 50 and 80 american dollars.</p>' +
    '<hr/>' + 
    '<h5 style="margin-bottom: -5px;">Italy<h5>' +
    '<p style="margin-bottom: 5px; font-size: 14px">' + '<strong>EUR: </strong>' + 'between 35 and 45 euros.</p>' +
    '<hr/>' + 
    '<h5 style="margin-bottom: -5px;">Argentina<h5>' +
    '<p style="margin-bottom: 5px; font-size: 14px">' + '<strong>USD: </strong>' + 'between 20 and 60 american dollars.</p>' +
    '<hr/>' + 
    '<h5 style="margin-bottom: -5px;">Kyrgystan<h5>' +
    '<p style="margin-bottom: 5px; font-size: 14px">' + '<strong>USD: </strong>' + 'between 20 and 30 american dollars.</p>' +
    '<hr/>' +
